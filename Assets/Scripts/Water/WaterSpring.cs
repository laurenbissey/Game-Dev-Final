...
public class WaterSpring : MonoBehaviour
{
    ...
    {
        if (other.gameObject.tag.Equals("Golfball"))
        {
            Golfball fallingObject = other.gameObject.GetComponent<Golfball>();
            Rigidbody2D rb = fallingObject.gameObject.GetComponent<Rigidbody2D>();
